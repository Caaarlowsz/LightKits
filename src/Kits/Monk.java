    ...
    public void aoMonk(final PlayerInteractEntityEvent e) {
        ...
        if (e.getRightClicked() instanceof Player) {
            ...
            if (Habilidade.getAbility(p).equalsIgnoreCase("Monk") && p.getItemInHand().getType() == Material.BLAZE_ROD) {
                ...
                jogadorClicado.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §6» §7Voc\u00ea Foi Monkado Arrume Seu Inventario");
                p.sendMessage(String.valueOf(String.valueOf(String.valueOf(Main.prefix)) + " §6» §7Voc\u00ea Monkou o Player " + jogadorClicado.getName()));
                Cooldown.add(p, 20);
