...
public class Avatar implements Listener {
	...
	public void ar(final PlayerInteractEvent e) {
		...
		if (Habilidade.getAbility(p).equalsIgnoreCase("Avatar")
			...
			h.setVelocity(velo1);
			h.setMetadata("ar", (MetadataValue) new FixedMetadataValue(LightPvP.plugin, (Object) true));
	...
	public void agua(final PlayerInteractEvent e) {
		...
		if (Habilidade.getAbility(p).equalsIgnoreCase("Avatar")
			...
			final Vector velo1 = p.getLocation().getDirection().normalize().multiply(10);
			h.setVelocity(velo1);
			h.setMetadata("agua", (MetadataValue) new FixedMetadataValue(LightPvP.plugin, (Object) true));
			Bukkit.getScheduler().scheduleSyncDelayedTask(LightPvP.plugin, (Runnable) new Runnable() {
				@Override
				public void run() {
					p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Seu CoolDown Foi Terminado");
	...
	public void terra(final PlayerInteractEvent e) {
		...
		if (Habilidade.getAbility(p).equalsIgnoreCase("Avatar")
			...
			final Vector velo1 = p.getLocation().getDirection().normalize().multiply(10);
			h.setVelocity(velo1);
			h.setMetadata("terra", (MetadataValue) new FixedMetadataValue(LightPvP.plugin, (Object) true));
			Bukkit.getScheduler().scheduleSyncDelayedTask(LightPvP.plugin, (Runnable) new Runnable() {
				@Override
				public void run() {
					p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Seu CoolDown Foi Terminado");
	...
	public void fogo(final PlayerInteractEvent e) {
		...
		if (Habilidade.getAbility(p).equalsIgnoreCase("Avatar")
			...
			final Vector velo1 = p.getLocation().getDirection().normalize().multiply(10);
			h.setVelocity(velo1);
			h.setMetadata("fogo", (MetadataValue) new FixedMetadataValue(LightPvP.plugin, (Object) true));
			Bukkit.getScheduler().scheduleSyncDelayedTask(LightPvP.plugin, (Runnable) new Runnable() {
				@Override
				public void run() {
					p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Seu CoolDown Foi Terminado");
