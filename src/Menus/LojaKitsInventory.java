...
public class LojaKitsInventory implements Listener, CommandExecutor
{
    ...
    public LojaKitsInventory(final Main main) {
    }
        ...
        if (e.getCurrentItem() != null && e.getCurrentItem().getItemMeta() != null) {
            ...
            if (e.getCurrentItem().isSimilar(LojaKitsInventory.ninja)) {
                if (Coins.XpM.getPlayerMoney(p) >= 4000) {
                    ...
                    p.sendMessage(String.valueOf(Main.prefix) + " §7Kit §cAVATAR§7 Adquirido Com Sucesso");
                    ScoreBoarding.setScoreBoard(p);
                    e.setCancelled(true);
                    p.closeInventory();
                }
                else if (Coins.XpM.getPlayerMoney(p) < 4000) {
                    p.sendMessage(String.valueOf(Main.prefix) + " §7Voc\u00ea N\u00e3o Tem Dinheiro o Suficiente Para Esta Compra");
                    e.setCancelled(true);
                    p.closeInventory();
                }
            }
            if (e.getCurrentItem().isSimilar(LojaKitsInventory.viking)) {
                if (Coins.XpM.getPlayerMoney(p) >= 15000) {
                    ...
                    p.sendMessage(String.valueOf(Main.prefix) + " §7Kit §cSTOMPER§7 Adquirido Com Sucesso");
                    ScoreBoarding.setScoreBoard(p);
                    e.setCancelled(true);
                    p.closeInventory();
                }
            ...
            if (e.getCurrentItem().isSimilar(LojaKitsInventory.stomper)) {
                if (Coins.XpM.getPlayerMoney(p) >= 1000) {
                    ...
                    p.sendMessage(String.valueOf(Main.prefix) + " §7Kit §cTHOR§7 Adquirido Com Sucesso");
                    e.setCancelled(true);
                    p.closeInventory();
                    ScoreBoarding.setScoreBoard(p);
                }
            ...
            if (e.getCurrentItem().isSimilar(LojaKitsInventory.viper)) {
                if (Coins.XpM.getPlayerMoney(p) >= 5000) {
                    ...
                    p.sendMessage(String.valueOf(Main.prefix) + " §7Kit §cSWORDS§7 Adquirido Com Sucesso");
                    e.setCancelled(true);
                    p.closeInventory();
                    ScoreBoarding.setScoreBoard(p);
                }
            ...
            if (e.getCurrentItem().isSimilar(LojaKitsInventory.snail)) {
                if (Coins.XpM.getPlayerMoney(p) >= 4000) {
                    ...
                    p.sendMessage(String.valueOf(Main.prefix) + " §7Kit §cFORCEFIELD§7 Adquirido");
                    e.setCancelled(true);
                    p.closeInventory();
                    ScoreBoarding.setScoreBoard(p);
                }
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("lojakits")) {
            ...
            (LojaKitsInventory.stompermeta = LojaKitsInventory.stomper.getItemMeta()).setDisplayName("§cKIT THOR - 1000 Money");
            ...
            (LojaKitsInventory.vikingmeta = LojaKitsInventory.viking.getItemMeta()).setDisplayName("§cKIT STOMPER - 15000 Money");
            ...
            (LojaKitsInventory.vipermeta = LojaKitsInventory.viper.getItemMeta()).setDisplayName("§cKIT SWORDS - 5000 Money");
            LojaKitsInventory.viper.setItemMeta(LojaKitsInventory.vipermeta);
            LojaKitsInventory.ninja = new ItemStack(Material.BEACON);
            (LojaKitsInventory.ninjameta = LojaKitsInventory.ninja.getItemMeta()).setDisplayName("§cKIT AVATAR - 4000 Money");
            ...
            (LojaKitsInventory.snailmeta = LojaKitsInventory.snail.getItemMeta()).setDisplayName("§cKIT FF - 4000 Money");
