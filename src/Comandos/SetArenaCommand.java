...
public class SetArenaCommand implements Listener, CommandExecutor {
	...
	public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
		...
		if (p.hasPermission("cmd.set") && label.equalsIgnoreCase("setarena")) {
			if (args.length == 0) {
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Especifique a Arena (1/7)");
				return true;
			}
			if (args[0].equalsIgnoreCase("1")) {
				LightPvP.getPlugin().getConfig();
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Arena 1 Setada");
			...
			if (args[0].equalsIgnoreCase("2")) {
				LightPvP.getPlugin().getConfig();
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Arena 2 Setada");
			...
			if (args[0].equalsIgnoreCase("3")) {
				LightPvP.getPlugin().getConfig();
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Arena 3 Setada");
			...
			if (args[0].equalsIgnoreCase("4")) {
				LightPvP.getPlugin().getConfig();
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Arena 4 Setada");
			...
			if (args[0].equalsIgnoreCase("5")) {
				LightPvP.getPlugin().getConfig();
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Arena 5 Setada");
			...
			if (args[0].equalsIgnoreCase("6")) {
				LightPvP.getPlugin().getConfig();
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Arena 6 Setada");
			...
			if (args[0].equalsIgnoreCase("7")) {
				LightPvP.getPlugin().getConfig();
				p.sendMessage(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6� �7Arena 7 Setada");
