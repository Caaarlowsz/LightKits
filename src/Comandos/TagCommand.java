        ...
        if (args.length != 0) {
            if (args[0].equalsIgnoreCase("normal")) {
                if (p.hasPermission("tag.normal")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &7&lJOGADOR &7");
                    return true;
                }
            ...
            if (args[0].equalsIgnoreCase("light")) {
                if (p.hasPermission("tag.light")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &a&lLIGHT &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("coder")) {
                if (p.hasPermission("tag.coder")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &3&lCoder &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("subdono")) {
                if (p.hasPermission("tag.subdono")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &c&lSUB&4&lDONO &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("builder+")) {
                if (p.hasPermission("tag.builder+")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &1&lBUILDER+ &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("master")) {
                if (p.hasPermission("tag.master")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &6&lMASTER &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("premium")) {
                if (p.hasPermission("tag.premium")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &e&lPREMIUM &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("ultimate")) {
                if (p.hasPermission("tag.ultimate")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &d§lULTIMATE &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("beta")) {
                if (p.hasPermission("tag.beta")) {
                    ...
                    p.setPlayerListName("§1" + getShortStr(p.getName()) + ChatColor.WHITE + ChatColor.ITALIC);
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &1§lBETA &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("youtuber")) {
                if (p.hasPermission("tag.youtuber")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &c§lY§f§lT &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("youtuber+")) {
                if (p.hasPermission("tag.youtuber+")) {
                    ...
                    p.setPlayerListName("§b" + getShortStr(p.getName()) + ChatColor.WHITE + ChatColor.ITALIC);
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " §c§lY§f§lT§3+ &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("ajudante")) {
                if (p.hasPermission("tag.ajudante")) {
                    ...
                    p.setPlayerListName("§3" + getShortStr(p.getName()) + ChatColor.WHITE + ChatColor.ITALIC);
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &3&lAJUDANTE &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            ...
            if (args[0].equalsIgnoreCase("trial")) {
                if (p.hasPermission("tag.trial")) {
                    ...
                    p.setPlayerListName("§d" + getShortStr(p.getName()) + ChatColor.WHITE + ChatColor.ITALIC);
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &d&lTRIAL &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            ...
            if (args[0].equalsIgnoreCase("gerente")) {
                if (p.hasPermission("tag.gerente")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &2&lGERENTE &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
            if (args[0].equalsIgnoreCase("semiyt")) {
                if (p.hasPermission("tag.semiyt")) {
                    ...
                    p.setPlayerListName("§7" + getShortStr(p.getName()) + ChatColor.WHITE + ChatColor.ITALIC);
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "ne prefix " + p.getName() + " &f&lSEMI-YT &7");
                    return true;
                }
                p.sendMessage(String.valueOf(String.valueOf(Main.prefix)) + " §7» §cSem Permiss\u00e3o");
            }
