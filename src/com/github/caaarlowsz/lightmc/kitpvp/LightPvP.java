...
public class LightPvP extends JavaPlugin implements KitPvP {
	...
	public void enable() {
		...
		LightPvP.ipsv = this.getConfig().getString("ip_do_sv").replace("&", "�");
		LightPvP.site = this.getConfig().getString("Site").replace("&", "�");
		LightPvP.prefix = this.getConfig().getString("Prefix").replace("&", "�");
		LightPvP.donos = this.getConfig().getString("Dono").replace("&", "�");
		LightPvP.aplicar = this.getConfig().getString("Formulario").replace("&", "�");
		LightPvP.motd = this.getConfig().getString("Motd").replace("&", "�");
		LightPvP.motd2 = this.getConfig().getString("Motd_Manutencao").replace("&", "�");
		new BukkitRunnable() {
			public void run() {
