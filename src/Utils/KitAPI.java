...
public class KitAPI implements Listener {
	...
	public static void recraft(final Player p) {
		...
		kespada1.setDisplayName(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6B\u00fassola");
	...
	public static void sword(final Player p) {
		...
		kespada.setDisplayName(String.valueOf(String.valueOf(LightPvP.prefix)) + " �6Espada");
