            ...
            public void run() {
                ...
                for (double t = 0.0; t <= 6.283185307179586; t += 0.19634954084936207) {
                    for (double i = 0.0; i <= 1.0; ++i) {
                        final double x = 0.4 * (6.283185307179586 - t) * 0.5 * Raios.cos(t + this.phi + i * 3.141592653589793);
                        final double y = 0.5 * t;
                        final double z = 0.4 * (6.283185307179586 - t) * 0.5 * Raios.sin(t + this.phi + i * 3.141592653589793);
                        loc.add(x, y, z);
                        loc.subtract(x, y, z);
                    }
                }
